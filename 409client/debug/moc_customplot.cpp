...
const QMetaObject CustomPlot::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CustomPlot.data,
...
void *CustomPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomPlot.stringdata0))
        return static_cast<void*>(const_cast< CustomPlot*>(this));
